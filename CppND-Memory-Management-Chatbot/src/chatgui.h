...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic; // change _chatLogic to a unique pointer
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { // get a raw pointer from the unique pointer to return
